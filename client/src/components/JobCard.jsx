    ...
    <Link to={`/job-detail/${job?._id}`}>
      ...
      <div className='flex gap-3'>
          ...
          <div className='w-full h-16 flex flex-col justify-center'>
            <p className='w-full h-12 flex iteme-center text-lg font-semibold overflow-hidden leading-5'>{job?.jobTitle}</p>
        ...
        <div className='py-3'>
          <p className='text-sm'>
          {job?.detail && job.detail[0]?.desc ? job.detail[0].desc.slice(0, 150) + "..." : ''}

            {/* воппросы к строке выше) */}
          </p>
        </div>
